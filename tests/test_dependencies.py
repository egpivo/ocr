...
@pytest.mark.usefixtures(
    "false_example_imgstring", "positive_example_imgstring", "expected_result"
)
def test_extract_text_from_image(
    ...
    with pytest.raises(HTTPException) as exc_info:
        ...
        extract_text_from_image(false_example_imgstring)
    ...
    # Test with a positive example_imgstring, expecting no errors
