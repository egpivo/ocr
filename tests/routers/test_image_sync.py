...
@pytest.mark.usefixtures("positive_example_image_string", "expected_result")
def test_extract_text_from_image_success(
    positive_example_image_string, expected_result
):
...
def test_extract_text_from_image_invalid_data(false_example_image_string):
    image_request = ImageRequest(data=false_example_image_string)
...
def test_extract_text_from_image_missing_data(positive_example_image_string):
